...
{$DEFINE SQLHandleClasses_unitheader}
{$INCLUDE SQLHandleClasses_Interface.inc}
...
{ TSQLHandleClassesRoot }

procedure TSQLHandleClassesRootList.Add(NewObject: TSQLHandleClassesRoot);
begin
  if Assigned(NewObject) then
    AddElement(NewObject);
end;

function TSQLHandleClassesRootList.IndexOf(anObject: TSQLHandleClassesRoot): Integer;
begin
  result := IndexOfElement(anObject);
end;

function TSQLHandleClassesRootList.Includes(anObject: TSQLHandleClassesRoot) : Boolean;
begin
  result := IncludesElement(anObject);
end;

function TSQLHandleClassesRootList.AddNew: TSQLHandleClassesRoot;
begin
  result := TSQLHandleClassesRoot(InternalAddNew);
end;

procedure TSQLHandleClassesRootList.Insert(index: Integer; NewObject: TSQLHandleClassesRoot);
begin
  if assigned(NewObject) then
    InsertElement(index, NewObject);
end;

function TSQLHandleClassesRootList.GetBoldObject(index: Integer): TSQLHandleClassesRoot;
begin
  result := TSQLHandleClassesRoot(GetElement(index));
end;

procedure TSQLHandleClassesRootList.SetBoldObject(index: Integer; NewObject: TSQLHandleClassesRoot);
begin;
...
begin
  BoldObjectListClasses.AddObjectEntry('SQLHandleClassesRoot', TSQLHandleClassesRootList);
...
begin
  BoldObjectClasses.AddObjectEntry('SQLHandleClassesRoot', TSQLHandleClassesRoot);
...
initialization
  CodeDescriptor := GeneratedCodes.AddGeneratedCodeDescriptorWithFunc('SQLHandleClasses', InstallBusinessClasses, InstallObjectListClasses, GeneratedCodeCRC);
finalization
