...
function TBoldSubscriptionNode.GetNext(Index: integer): TBoldMultiIndexedListNode;
begin
...
function TBoldSubscriptionNode.GetPrevious(Index: integer): TBoldMultiIndexedListNode;
begin
  Assert((Index >= 0) and (Index < NumberOfIndices));
  Result := fPreviousNodes[Index];
end;

procedure TBoldSubscriptionNode.SetNext(Index: integer; Value: TBoldMultiIndexedListNode);
begin
  fNextNodes[Index] := Value;
end;

procedure TBoldSubscriptionNode.SetPrevious(Index: integer; Value: TBoldMultiIndexedListNode);
begin
